...
import sschr15.aocsolutions.util.graphs.addEdgeAndVertices
import sschr15.aocsolutions.util.graphs.directedGraphOf
import sschr15.aocsolutions.util.graphs.incomingEdgesOf
import sschr15.aocsolutions.util.graphs.toDot
...
//        test()
        ...
        fun getRegister(register: String): Boolean {
            ...
            val (a, b) = deps.incomingEdgesOf(register).map { it.oppositeOf(register) }
            return when (op) {
        ...
        part1 {
            ...
            for (line in inputLines.last().lines()) {
                ...
                deps.addEdgeAndVertices(a, res)
                deps.addEdgeAndVertices(b, res)
