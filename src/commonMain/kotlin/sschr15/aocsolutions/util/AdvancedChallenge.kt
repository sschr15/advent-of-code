...
import sschr15.aocsolutions.setClipboard
...
class AdvancedChallenge(private val year: Int, private val day: Int, private val builder: Builder) : Challenge {
    ...
    private fun copyToClipboard(text: String) {
        if (getProperty("aoc.skip.clipboard.copy") == "true" || builder._test) return
        setClipboard(text)
    }
    ...
    class ChallengePart(
        ...
        internal val _out = StringBuilder()
        @PublishedApi
