...
inline fun plus(a: Int, b: Int): Int {
    val res = a + b
...
inline fun minus(a: Int, b: Int): Int {
    val res = a - b
    if ((a xor res) and (b xor res) < 0) {
        throw ArithmeticException("Integer overflow")
    }
...
inline fun times(a: Int, b: Int): Int {
...
inline fun unaryMinus(a: Int): Int {
    if (a == Int.MIN_VALUE) {
        throw ArithmeticException("Integer overflow")
    }
    return -a
...
inline fun plus(a: Long, b: Long): Long {
    val res = a + b
    if ((a xor res) and (b xor res) < 0) {
        throw ArithmeticException("Integer overflow")
    }
...
inline fun minus(a: Long, b: Long): Long {
    val res = a - b
    if ((a xor res) and (b xor res) < 0) {
        throw ArithmeticException("Integer overflow")
    }
...
inline fun times(a: Long, b: Long): Long {
...
inline fun unaryMinus(a: Long): Long {
    if (a == Long.MIN_VALUE) {
        throw ArithmeticException("Integer overflow")
    }
    return -a
...
inline fun toInt(a: Long): Int = if (a > Int.MAX_VALUE || a < Int.MIN_VALUE) throw ArithmeticException("Not enough precision") else a.toInt()
